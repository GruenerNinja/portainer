...
docker build --platform linux/arm64 -t themodcrafttmc/portainer:2.39.3.2.10 -t themodcrafttmc/portainer:latest .
```
...
```sh
docker push themodcrafttmc/portainer:2.39.3.2.10
